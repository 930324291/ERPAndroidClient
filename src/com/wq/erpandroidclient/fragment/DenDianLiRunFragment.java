 ...
 */
public class DenDianLiRunFragment extends Fragment implements OnItemClickListener, OnClickListener {
...
//		return sb.toString();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View rootView = inflater.inflate(R.layout.men_dian_li_run_fragment_layout, container, false);
...
//			"备注":""
			...
			public void dataView(View convertView, ContentValues value, int position) {
				...
				tv2.setText(value.getAsString("业务伙伴名称"));
				tv3.setText(value.getAsString("年度"));
				tv4.setText(value.getAsString("月份"));
...
//		return sb.toString();
	...
	private void getData() {
		// p_Report_QryMallProfit(ByVal _bMallCode As String, ByVal _eMallCode
		// As String, ByVal _bDate As String, ByVal _eDate As String)
		// 参数： _bMallCode 代表　开始门店编码，此参数不可为空，为空时不允许查询
		// _eMallCode 代表　结束的门店编码，此参数不可为空，为空时不允许查询
		// 　　　　_bDate　代表　查询的开始日期
		// _eDate 代表　查询的结束日期
		// 　　返回值 json
		// 注：其中的门店编码，需要通过接口获取getMallInfo，如果获取不到门店则不允许查询该报表
		...
		}, "p_Report_QryMallProfit", params, "http://SuperLogis.org/p_Report_QryMallProfit");
